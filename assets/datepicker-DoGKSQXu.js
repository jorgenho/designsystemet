...
`,e.jsx(l,{of:s})]})}function p(n={}){const{wrapper:r}=n.components||{};return r?e.jsx(r,{...n,children:e.jsx(d,{...n})}):d(n)}function t(n,r){throw new Error("Expected component `"+n+"` to be defined: you likely forgot to import, pass, or provide it.")}export{p as default,c as frontmatter,f as structuredData,h as toc};
