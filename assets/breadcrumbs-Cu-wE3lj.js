...
`,e.jsx(t,{of:i.Link})]})}function b(n={}){const{wrapper:r}=n.components||{};return r?e.jsx(r,{...n,children:e.jsx(d,{...n})}):d(n)}function l(n,r){throw new Error("Expected component `"+n+"` to be defined: you likely forgot to import, pass, or provide it.")}export{b as default,c as frontmatter,h as structuredData,m as toc};
