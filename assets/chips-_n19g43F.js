...
`,e.jsxs(n.ul,{children:[`
`,e.jsx(n.li,{children:"du lager menyer (f.eks. sidemeny eller hovedmeny)"}),`
...
`,e.jsxs(n.li,{children:["du trenger aksjons- eller innsendingselementer i skjema — bruk ",e.jsx(n.a,{href:"/byggeklosser/komponenter/button",children:"Button"})]}),`
...
`,e.jsx(n.li,{children:"Vi skiller mellom lukkbar og valgbar variant for å gi tydelig forventning om hva som skjer når brukeren klikker."}),`
`,e.jsx(n.li,{children:"For lukkbare chips er det å styre fokus et kjent tilgjengelighetsproblem: tastaturbrukere risikerer å miste fokus når et valgt element fjernes, og må orientere seg på nytt."}),`
`]}),`
...
`,e.jsx(t,{of:i.Toggle})]})}function c(r={}){const{wrapper:n}=r.components||{};return n?e.jsx(n,{...r,children:e.jsx(s,{...r})}):s(r)}function a(r,n){throw new Error("Expected component `"+r+"` to be defined: you likely forgot to import, pass, or provide it.")}export{c as default,h as frontmatter,k as structuredData,u as toc};
